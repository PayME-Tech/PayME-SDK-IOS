...
class ListItem: UITableViewCell {
  ...
  func setupCell() {
    ...
    logLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 10).isActive =
      true
    logLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -10)
      .isActive = true
...
class ModalController: UIViewController, UITableViewDataSource, UITableViewDelegate {
  ...
  override func viewDidLoad() {
    ...
    closeButton.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: -50)
      .isActive = true
    ...
    logContainer.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 20).isActive =
      true
    logContainer.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: -20)
      .isActive = true
    logContainer.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: -50).isActive =
      true
    ...
    clearButton.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 30).isActive =
      true
  ...
  override func viewDidAppear(_ animated: Bool) {
    ...
    if (logListData.count - 1) > 0 {
      logContainer.scrollToRow(
        at: IndexPath(row: logListData.count - 1, section: 0),
  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    let alert = UIAlertController(
      title: "Copy", message: "Copied to clipboard", preferredStyle: UIAlertController.Style.alert)
