...
class SettingsView: UIViewController, UIScrollViewDelegate {
  ...
  override func viewDidLoad() {
    ...
    contentView.heightAnchor.constraint(equalTo: self.view.heightAnchor, constant: 100).isActive =
      true

    secretKey.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 30).isActive = true
    secretKey.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30).isActive =
      true

    secretKeyTextField.topAnchor.constraint(equalTo: secretKey.bottomAnchor, constant: 5).isActive =
      true
    secretKeyTextField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30)
      .isActive = true
    secretKeyTextField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -30)
      .isActive = true
    secretKeyTextField.text = EnvironmentSettings.standard.secretKey

    appToken.topAnchor.constraint(equalTo: secretKeyTextField.bottomAnchor, constant: 40).isActive =
      true
    appToken.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30).isActive =
      true

    appTokenTextField.topAnchor.constraint(equalTo: appToken.bottomAnchor, constant: 5).isActive =
      true
    appTokenTextField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30)
      .isActive = true
    appTokenTextField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -30)
      .isActive = true
    appTokenTextField.text = EnvironmentSettings.standard.appToken

    appPrivateKey.topAnchor.constraint(equalTo: appTokenTextField.bottomAnchor, constant: 20)
      .isActive = true
    appPrivateKey.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30)
      .isActive = true

    appSKTextField.topAnchor.constraint(equalTo: appPrivateKey.bottomAnchor, constant: 5).isActive =
      true
    appSKTextField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30)
      .isActive = true
    appSKTextField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -30)
      .isActive = true
    appSKTextField.text = EnvironmentSettings.standard.privateKey

    appPublicKey.topAnchor.constraint(equalTo: appSKTextField.bottomAnchor, constant: 20).isActive =
      true
    appPublicKey.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30)
      .isActive = true

    appPKTextField.topAnchor.constraint(equalTo: appPublicKey.bottomAnchor, constant: 5).isActive =
      true
    appPKTextField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30)
      .isActive = true
    appPKTextField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -30)
      .isActive = true
    appPKTextField.text = EnvironmentSettings.standard.publicKey

    checkBox.topAnchor.constraint(equalTo: appPKTextField.bottomAnchor, constant: 20).isActive =
      true
    checkBox.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30).isActive =
      true
    checkBox.heightAnchor.constraint(equalToConstant: 20).isActive = true
    checkBox.widthAnchor.constraint(equalToConstant: 20).isActive = true
    checkBox.addTarget(self, action: #selector(onPressCheckbox(_:)), for: .touchUpInside)

    showLogLabel.topAnchor.constraint(equalTo: appPKTextField.bottomAnchor, constant: 20).isActive =
      true
    showLogLabel.leadingAnchor.constraint(equalTo: checkBox.trailingAnchor, constant: 10).isActive =
      true
    ...
    restoreButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30)
      .isActive = true
    restoreButton.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -30)
      .isActive = true
  ...
  @IBAction func onPressSave(_ sender: UIButton) {
    EnvironmentSettings.standard.changeSettings(
      newAppToken: self.appTokenTextField.text, newPrivateKey: self.appSKTextField.text,
      newPublicKey: self.appPKTextField.text, newSecretKey: self.secretKeyTextField.text)
