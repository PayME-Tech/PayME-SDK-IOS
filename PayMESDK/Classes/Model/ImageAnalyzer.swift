...
import Foundation
  ...
  final class ImageAnalyzer {
    ...
    lazy var requestHandler: ((VNRequest, Error?) -> Void)? = { [weak self] request, _ in
      ...
      let prefixes = [
        "9704", "4", "51", "52", "53", "54", "55", "2221", "2229", "223", "229", "23", "26", "270",
        "271", "2720", "2131", "1800", "35",
      ]
      ...
      for result in results {
        ...
        if creditCardNumber.hasMatch(in: string) && (prefixes.contains(where: string.hasPrefix)) {
      ...
      let strongCond =
        strongSelf.selectedCard.number != nil
