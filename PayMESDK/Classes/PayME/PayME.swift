...
public class PayME {
  ...
  public init(
    appToken: String, publicKey: String, connectToken: String, appPrivateKey: String,
    language: String? = PayME.Language.VIETNAMESE, env: Env, configColor: [String], showLog: Int = 0
  ) {
    PayME.configColor = configColor
    payMEFunction = PayMEFunction(
      appToken, publicKey, connectToken, appPrivateKey, language, env, configColor, showLog,
      PayME.getAppId(appToken))
  }
  ...
  public func deposit(
    ...
    payMEFunction.openWallet(
      true, currentVC, PayME.Action.DEPOSIT, amount, nil, nil, "", closeWhenDone, onSuccess, onError
    )
  }
  ...
  public func withdraw(
    ...
    payMEFunction.openWallet(
      true, currentVC, PayME.Action.WITHDRAW, amount, nil, nil, "", closeWhenDone, onSuccess,
      onError)
  }
  ...
  public func transfer(
    ...
    payMEFunction.openWallet(
      true, currentVC, PayME.Action.TRANSFER, amount, description, nil, "", closeWhenDone,
      onSuccess, onError)
  }
  ...
  public func openHistory(
    ...
    payMEFunction.openWallet(
      true, currentVC, PayME.Action.OPEN_HISTORY, nil, "", nil, "", false, onSuccess, onError)
  }
  ...
  public func openService(
    ...
    payMEFunction.openWallet(
      true, currentVC, PayME.Action.UTILITY, amount, nil, nil, service.code, false, onSuccess,
      onError)
  }

  public func openWallet(
    currentVC: UIViewController, action: Action, amount: Int?, description: String?,
    extraData: String?,
    onSuccess: @escaping ([String: AnyObject]) -> Void,
    onError: @escaping ([String: AnyObject]) -> Void
  ) {
    payMEFunction.openWallet(
      false, currentVC, action, amount, description, extraData, "", false, onSuccess, onError)
  }
  ...
  public func pay(
    ...
    payMEFunction.payAction(
      currentVC: currentVC, storeId: storeId, userName: userName, orderId: orderId, amount: amount,
      note: note,
  ...
  public func scanQR(
    ...
    payMEFunction.openQRCode(
      currentVC: currentVC, payCode: payCode, onSuccess: onSuccess, onError: onError,
      isStartDirectFromUser: true)
  }
  ...
  public func payQRCode(
    ...
    payMEFunction.payQRCode(
      currentVC: currentVC, qr: qr, payCode: payCode, isShowResultUI: isShowResultUI,
      onSuccess: onSuccess, onError: onError)
  }
  ...
  public func getRemainingQuota(
    onSuccess: @escaping (Int) -> Void, onError: @escaping ([String: AnyObject]) -> Void
  ) {
