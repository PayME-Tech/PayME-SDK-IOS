...
class BankTransferResultView: UIView {
  ...
  let image: UIImageView = {
    let image = UIImageView(
      image: UIImage(for: BankTransferResultView.self, named: "iconBankTransPending"))
  ...
  func updateUI(type: ResultType) {
    ...
    case .PENDING:
      ...
      let animation = LottieAnimation.named("Kiemtralenhchuyentien", bundle: resourceBundle!)
