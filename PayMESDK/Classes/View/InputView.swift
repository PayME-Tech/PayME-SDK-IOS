...
class InputView: UIView {
  ...
  init(
    title: String, placeholder: String = "", keyboardType: UIKeyboardType = .default,
  ...
  func setupUI() {
    ...
    textInput.trailingAnchor.constraint(equalTo: extraImage.trailingAnchor, constant: -8).isActive =
      true

    extraLabel.topAnchor.constraint(equalTo: topAnchor, constant: 8).isActive = true
    extraLabel.leadingAnchor.constraint(equalTo: titleLabel.trailingAnchor, constant: 4).isActive =
      true
    ...
    extraImageTrailing = extraImage.trailingAnchor.constraint(
      equalTo: extraIcon.leadingAnchor, constant: -12)
  ...
  func updateExtraIcon(iconImage: UIImage?, onPress: @escaping () -> Void = {}) {
