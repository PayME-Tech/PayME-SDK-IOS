...
class PopupKYC: UIViewController, PanModalPresentable {
  ...
  func setupViewDocument() {
    ...
    view.safeAreaLayoutGuide.bottomAnchor.constraint(
      greaterThanOrEqualTo: popupDocument.continueButton.bottomAnchor, constant: paddingBottom
    ).isActive = true
  }
  ...
  func setupViewFace() {
    ...
    let paddingBottom = ((safeAreaInset?.bottom ?? 0 == 0) ? 16 : 0) as CGFloat
    view.safeAreaLayoutGuide.bottomAnchor.constraint(
      greaterThanOrEqualTo: popupFace.continueButton.bottomAnchor, constant: paddingBottom
    ).isActive = true
  }
  ...
  func setupViewVideo() {
    ...
    let paddingBottom = ((safeAreaInset?.bottom ?? 0 == 0) ? 16 : 0) as CGFloat
    view.safeAreaLayoutGuide.bottomAnchor.constraint(
      greaterThanOrEqualTo: popupVideo.continueButton.bottomAnchor, constant: paddingBottom
    ).isActive = true
  }
...
private class PopupDocument: UIView {
  ...
  init() {
    ...
    titleLabel.leadingAnchor.constraint(equalTo: rootView.leadingAnchor, constant: 20).isActive =
      true
    titleLabel.trailingAnchor.constraint(equalTo: rootView.trailingAnchor, constant: -20).isActive =
      true

    contentContainer.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 11).isActive =
      true
    ...
    animationView.topAnchor.constraint(equalTo: contentContainer.bottomAnchor, constant: 10)
      .isActive = true
    ...
    continueButton.widthAnchor.constraint(equalTo: rootView.widthAnchor, constant: -34).isActive =
      true
    continueButton.bottomAnchor.constraint(equalTo: rootView.bottomAnchor, constant: -20).isActive =
      true

    let bundle = Bundle(for: ResultView.self)
    let bundleURL = bundle.resourceURL?.appendingPathComponent("PayMESDK.bundle")
    let resourceBundle = Bundle(url: bundleURL!)
    let animation = LottieAnimation.named("Chup_CMNN", bundle: resourceBundle!)
...
private class PopupFace: UIView {
  ...
  init() {
    ...
    animationView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 10).isActive =
      true
    animationView.centerXAnchor.constraint(equalTo: rootView.centerXAnchor).isActive = true
    animationView.setContentCompressionResistancePriority(.fittingSizeLevel, for: .horizontal)
    ...
    let bundleURL = bundle.resourceURL?.appendingPathComponent("PayMESDK.bundle")
    let resourceBundle = Bundle(url: bundleURL!)
    let animation = LottieAnimation.named("take_face", bundle: resourceBundle!)
    animationView.animation = animation
...
private class PopupVideo: UIView {
  ...
  init() {
    ...
    animationView.widthAnchor.constraint(equalToConstant: 193).isActive = true
    animationView.heightAnchor.constraint(equalToConstant: 193).isActive = true
    animationView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 22).isActive =
      true
    animationView.centerXAnchor.constraint(equalTo: rootView.centerXAnchor).isActive = true
    animationView.setContentCompressionResistancePriority(.fittingSizeLevel, for: .horizontal)
    ...
    let bundleURL = bundle.resourceURL?.appendingPathComponent("PayMESDK.bundle")
    let resourceBundle = Bundle(url: bundleURL!)
    let animation = LottieAnimation.named("take_video", bundle: resourceBundle!)
    animationView.animation = animation
