...
class KYCBackController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    if #available(iOS 11, *) {
      ...
      NSLayoutConstraint.activate([
        ...
        titleLabel.topAnchor.constraint(
          equalToSystemSpacingBelow: guide.topAnchor, multiplier: 1.4),
      ...
      NSLayoutConstraint.activate([
        ...
        captureAgain.bottomAnchor.constraint(
          equalTo: bottomLayoutGuide.topAnchor, constant: -standardSpacing),
        confirm.bottomAnchor.constraint(
          equalTo: bottomLayoutGuide.topAnchor, constant: -standardSpacing),
      ])
    }
    ...
    captureAgain.widthAnchor.constraint(equalToConstant: (screenSize.width / 2) - 20).isActive =
      true
    ...
    imageView.heightAnchor.constraint(equalToConstant: (screenSize.width - 32) * 0.67).isActive =
      true
    ...
    confirmTitle.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16).isActive =
      true
  ...
  override func viewDidLayoutSubviews() {
    let colorButton = [
      ...
      UIColor(hexString: PayME.configColor.count > 1 ? PayME.configColor[1] : PayME.configColor[0])
        .cgColor,
    ]
