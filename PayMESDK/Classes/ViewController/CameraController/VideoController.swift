...
class VideoController: UIViewController, UIImagePickerControllerDelegate,
  UINavigationControllerDelegate
{
  ...
  override func viewDidLoad() {
    ...
    if #available(iOS 11, *) {
      ...
      NSLayoutConstraint.activate([
        ...
        animationButton.bottomAnchor.constraint(
      ...
      if cameraCaptureOutput!.isRecording == false {
        ...
        if #available(iOS 11.0, *) {
          if cameraCaptureOutput!.availableVideoCodecTypes.contains(.h264) {
            cameraCaptureOutput!.setOutputSettings(
              [AVVideoCodecKey: AVVideoCodecType.h264], for: connection!)
          }
        }
  ...
  func setupAnimation() {
    ...
    let animation = LottieAnimation.named("Dangquay_3", bundle: resourceBundle!)
